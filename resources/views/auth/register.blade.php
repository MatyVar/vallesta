...
@section('content')
    <div class="container mx-auto max-w-screen-md">
        <div class="flex flex-wrap justify-center">
            <div class="md:w-1/2 order-1">
                <div class="w-full max-w-sm">
                    <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                        ...
                        <form method="POST" class="py-10 px-5" action="{{ route('register') }}">
                            @csrf
                            ...
                            <div class="flex flex-wrap">
                                <button type="submit"
                                    class="bg-red-400  w-full hover:bg-red-500 text-gray-100 p-3 focus:outline-none focus:shadow-outline uppercase">
                                    {{ __('Register') }}
                                </button>
                            </div>
            ...
            <div class="md:w-1/2 order-2 text-center flex flex-col justify-center px-10 mt-10">
                <h1 class="text-red-400 text-3xl">Eres reclutador?</h1>
                <p class="text-xl mt-5 leading-7">Crea una cuenta totalmenta gratis y comienza a publicar hasta 10 vacantes.</p>
            </div>
