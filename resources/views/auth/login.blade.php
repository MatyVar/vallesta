        ...
        <div class="flex flex-wrap justify-center">
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-20">
                    ...
                    <form method="POST" class="py-10 px-5" action="{{ route('login') }}">
                        @csrf
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="password" class="block text-gray-700 text-sm mb-2">{{ __('Password') }}
                            </label>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input class="mr-5 mt-1" type="checkbox" name="remember" id="remember"
